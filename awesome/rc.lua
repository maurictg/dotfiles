...
local function set_wallpaper(s)
    -- Wallpaper
    beautiful.wallpaper = "/home/maurict/.config/maurict/wallpaper.jpg"
...
globalkeys =
    ...
    -- 13 = R https://gist.github.com/rickyzhang82/8581a762c9f9fc6ddb8390872552c250 eerste kolom
    awful.key(
        {modkey},
        "#27",
        function()
    ...
    awful.key(
        ...
        {description = "open thunar", group = "client"}
    ), -- Custom
    awful.key(
        {},
        "XF86MonBrightnessUp",
    ...
    awful.key(
        ...
        "s",
        function()
            awful.util.spawn("gnome-screenshot --interactive -a")
        end,
        {
    ...
    awful.key(
        ...
        "i",
        function()
            awful.util.spawn("setxkbmap il")
        end,
        {
            description = "Set keyboard to hebrew",
            group = "client"
        }
    ),
    awful.key(
